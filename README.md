...
**Opsi 1: Full Development**
- Biaya: Rp 50.000.000 - Rp 75.000.000 (untuk multi-platform: Backend + Mobile + Web)
- Termin: DP 40%, Progress 30%, Pelunasan 30% saat live deployment
- Termasuk: Backend API, Mobile App (iOS + Android), Web App, Admin Panel, semua integrasi

**Opsi 2: MVP Phase (Backend + Web Only)**
- Biaya: Rp 25.000.000 - Rp 35.000.000
- Termin: DP 50%, Pelunasan 50% saat live deployment
- Termasuk: Backend API, Web App responsif, Admin Panel, integrasi dasar
- Mobile App dikembangkan di fase berikutnya (estimasi tambahan Rp 15.000.000 - Rp 25.000.000)

**Opsi 3: Kolaborasi + Revenue Share**
- Biaya awal: Rp 20.000.000 - Rp 30.000.000
- Maintenance: Rp 1.000.000 - Rp 2.000.000 per bulan
- Revenue share: 5-10% dari transaksi marketplace (negotiable)
- Termasuk: Full platform (Backend + Mobile + Web), maintenance, dan support

### Maintenance dan Support

- **Bug fixing**: 2 bulan setelah deployment (included dalam project)
- **Feature request**: Diestimasi terpisah sebagai change request
- **Monthly maintenance**: Rp 1.000.000 - Rp 2.000.000 per bulan
  - Server monitoring dan uptime
  - Dependency update dan security patch
  - Minor bug fix dan optimization
  - Technical support (response time 24-48 jam)
- **SLA**: Response time 24 jam untuk bug kritikal, 48 jam untuk bug non-kritikal

## Batasan Scope

- Scope mengikuti dokumen README.md, PLAN.md, TASK.md, CLAUDE.md dan kesepakatan tertulis.
- Integrasi bergantung pada ketersediaan dan approval API pihak ketiga (Midtrans, KiriminAja, SMS provider, dll).
- Perubahan arsitektur besar, fitur baru di luar scope, dan integrasi tambahan dikenakan biaya tambahan.
- Operasional non-teknis seperti komplain user, dispute bisnis, dan refund manual bukan tanggung jawab maintenance teknis kecuali disepakati.
- Mobile app review process (Apple App Store dan Google Play Store) membutuhkan waktu tambahan 1-2 minggu dan bergantung pada approval dari platform.
- Konten, branding, dan asset visual (logo, banner, ilustrasi) disediakan oleh klien atau dikenakan biaya tambahan untuk design service.

## Deliverable

### Phase MVP (Backend + Web)
- Backend API (Go) siap production dengan dokumentasi endpoint
- Web App (Next.js) responsif untuk desktop dan mobile browser
- Admin Panel lengkap dengan dashboard dan management tools
- Sistem marketplace, order, payment, escrow/wallet berjalan
- Integrasi Midtrans, KiriminAja, WhatsApp/Email blast
- Database schema dan migration files
- Docker Compose untuk deployment
- Dokumentasi deployment dan operasional

### Phase Full (Backend + Mobile + Web)
- Semua deliverable Phase MVP
- Mobile App (Flutter) untuk iOS dan Android
- Push notification via Firebase Cloud Messaging
- App Store dan Google Play Store submission (optional, dikenakan biaya tambahan untuk developer account)
- Dokumentasi API untuk mobile integration
- Testing report dan UAT checklist
